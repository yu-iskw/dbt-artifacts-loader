resource "google_service_account" "dbt_artifacts_loader_cloud_run" {
  ...
  account_id   = "dbt-artifacts-loader-cloud-run"
  display_name = "dbt-artifacts-loader-cloud-run"
...
resource "google_service_account" "cloud_run_invoker" {
  ...
  account_id   = "dbt-artifacts-loader-invoker"
  display_name = "dbt-artifacts-loader-invoker"
